...
class Bird:
    ...
    def if_bird_strike(self,pipes_pos):
        ...
        flag = 0
        if pipes_pos[0][0]-28 < self.rect.x < pipes_pos[0][0]+78:
    ...
    def cal_score(self,pipes_pos):
        if pipes_pos[0][0]+30 < self.rect.x and pipes_pos[0][0]+30+self.settings.pipe_speed >= self.rect.x:#这里判断的是上一帧经过管道，而下一帧经过了管道
            self.score += 1