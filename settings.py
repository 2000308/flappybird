...
class Settings:
    def __init__(self):
        ...
        self.pipe_speed = 3            #管道移动的速度，即整个画面移动的速度，默认为1，快速4
        self.max_y_vel = 5             #小鸟的最大速度（向下），默认为3，快速7
        self.flap_y_vel = -6.5          #初始的向上速度，也即是扇动翅膀后的向上速度，默认-5，快速-7.5
        self.gravity = 0.65             #小鸟向下的加速度，默认0.5,快速1
